...
static const Key keys[] = {
    ...
    { MODKEY | ShiftMask, XK_Return, quit,          {0} },  // quit dwm
    ...
    { MODKEY | ShiftMask, XK_b, spawn, KILLALLCMD(TORRENT) },
    
    { MODKEY,             XK_v, spawn, {.v = musiccmd}   },
    { MODKEY | ShiftMask, XK_v, spawn, KILLALLCMD(MUSIC) },
    ...
    { MODKEY | ShiftMask, XK_c, spawn, KILLALLCMD(GAME_C) },
    ...
    { MODKEY | ShiftMask, XK_5, spawn, SHCMD("killall ffplay") },
